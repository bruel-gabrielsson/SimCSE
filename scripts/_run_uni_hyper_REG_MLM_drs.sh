    ...
    do 
        for dropout_rate in "${dropout_rates[@]}"
            ...
            do
                ...
                output_dir="/skunk-pod-storage-brg-40mit-2eedu-pvc/DATA/simcse-data/HYPER/Jan13_025REG_MLM/REGMLM_L${layer}_b${batch_size}_lr${learning_rate}_dr${dropout_rate}"

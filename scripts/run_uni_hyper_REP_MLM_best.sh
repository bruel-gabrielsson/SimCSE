...
do 
    ...
    do 
        ...
        do
            ...
            output_dir="/skunk-pod-storage-brg-40mit-2eedu-pvc/DATA/simcse-data/HYPER/REPMLMBest/BestREPMLM_L${layer}_b${batch_size}_lr${learning_rate}"

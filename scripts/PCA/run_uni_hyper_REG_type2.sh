...
declare -a layers=(7 8 9 10 11 12 13)
...
do 
    ...
    do 
        ...
        do
            ...
            output_dir="/mnt2/brg/simcse-data/HYPER/PCA${size}_REG_PERTOKEN_JAN19/PCAREG_L${layer}_b${batch_size}_lr${learning_rate}_s${size}"

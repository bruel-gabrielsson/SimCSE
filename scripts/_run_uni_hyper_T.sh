...
do 
    ...
    do 
        ...
        do
            ...
            #output_dir="/mnt2/brg/simcse-data/HYPER/T/ST_L${layer}_b${batch_size}_lr${learning_rate}"
            output_dir="/skunk-pod-storage-brg-40mit-2eedu-pvc/storage/simcse/HYPER/T/ST_L${layer}_b${batch_size}_lr${learning_rate}"

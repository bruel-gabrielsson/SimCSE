...
do 
    ...
    do 
        ...
        do
            ...
            output_dir="/mnt/brg/simcse-data/HYPER/ONLY_LAYER/ONLYL_L${layer}_b${batch_size}_lr${learning_rate}"
            echo "device ${device} batch_size ${batch_size} output_dir ${output_dir}"
            CUDA_VISIBLE_DEVICES="${device}" python train.py \
                --dropout_only_layer $layer \

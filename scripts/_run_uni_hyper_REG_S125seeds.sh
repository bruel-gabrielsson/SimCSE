...
declare -a learning_rates=(1e-5 3e-5 5e-5) #  5e-5)
    ...
    do 
        ...
        do 
            ...
            do
                ...
                #output_dir="/skunk-pod-storage-brg-40mit-2eedu-pvc/DATA/simcse-data/HYPER/REG_D125_SEED${seed}/RD125_L${layer}_b${batch_size}_lr${learning_rate}"
                output_dir="/mnt2/brg/simcse-data/HYPER/REG_D125_SEED${seed}/RD125s${seed}_L${layer}_b${batch_size}_lr${learning_rate}"
                echo "device ${device} batch_size ${batch_size} output_dir ${output_dir}"
                CUDA_VISIBLE_DEVICES="${device}" python train.py \
                    --transform_layer $layer \
                    --higher_transform_p 0.5 \
                    --higher_dropout_p 0.125 \
                    --seed $seed \

...
declare -a learning_rates=(5e-5 1e-5 3e-5) #  5e-5)
    ...
    do 
        ...
        do 
            ...
            do
                ...
                output_dir="/mnt2/brg/simcse-data/HYPER/REG_MLMO_ODA_S${seed}/REGMLMO_L${layer}_b${batch_size}_lr${learning_rate}_s${seed}"
